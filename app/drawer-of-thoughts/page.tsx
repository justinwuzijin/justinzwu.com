...
const thoughts = [
  ...
  },
  {
    ...
    items: [
      ...
      'week 1-4 findings: being in an environment where everyone is ambitious and motivated → work doesnt feel like work + more work is produced (even in other fields of interest). e.g. i made more videos whilst juggling eng workload, design team, clubs, tech events, start-up building, applying to jobs + resume stuff compared to when i was in a slower paced markham.)',
      ...
      'march 7. a reminder of why im doing what im doing and working so hard to make the best of my resources and privilege. today is the one year anniversary of my waterloo offer; the day that was not an individual achievement, but a special moment for my family. Their 25th anniversary of moving to Canada was the next day (March 8th). Being able to create such a great environment for my sister and I was the real achievement. still cherishing and can see vividly the day I came home to my dad last year and gave him a big hug after receiving the offer. thinking back on all the days in high school, doubting myself and struggling academically, especially in that grade 7-8 time period (hadn’t read a single full chapter book at that point in my life and was lwky a chud), and the mindset shift during COVID that made me hungry for improvement and to be ambitious. everything is developed over time.',
      'always cheer for your friends.',
      'always show your appreciation for your friends.',
      'not tolerating disrespect from others is a form of self-respect. what a burden off your shoulders it is when you actually put this into practice.',
    ],
  },
]
