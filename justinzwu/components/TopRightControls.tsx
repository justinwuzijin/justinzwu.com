...
const socialLinks = [
  ...
  { 
    name: 'LinkedIn', 
    url: 'https://www.linkedin.com/in/justin-wu-171481162/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export function TopRightControls() {
  ...
  return (
    <div className={styles.controls}>
      <div className={styles.fluidContainer} data-expanded={isExpanded}>
        {/* Hamburger icon trigger button - always visible */}
        <button
        ...
        {/* Social links - expand horizontally to the left with menuitem.svg background */}
        {socialLinks.map((link, index) => (
          <a
            ...
            style={{
              transform: `translateX(${isExpanded ? -(index + 1) * 50 : 0}px)`,
