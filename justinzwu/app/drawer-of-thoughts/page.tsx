...
const thoughts = [
  ...
  },
  {
    ...
    items: [
      ...
      'learning how to be happy for others while also counting your own wins — challenges of being in a cohort that is so ambitious and everyone was president of major clubs @ school, super smart, max out people skills and professional skillsets already',
      ...
      'how to trust process and maintain a good attitude.',
      ...
      'make sure you are humble but do not be humbled by other ppl',
      'bring at a crossroads between all these identities and having ppl compromise to meet ur needs',
      'follow your gut.',
